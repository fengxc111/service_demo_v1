...
sock_str_timeval(union val *ptr, int len){
    if (len != sizeof(struct timeval))
        snprintf(strres, sizeof(strres), "size (%d) not sizepf(struct timeval", len);
    else
        snprintf(strres, sizeof(strres), "%d sec, %d usec", ptr->timeval_val.tv_sec, ptr->timeval_val.tv_usec);
